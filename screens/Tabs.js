  ...
  useEffect(()=>{
    if(route.params["activeBounty"] != null){
      navigation.navigate('Active Bounty', {
        activeBounty: route.params.activeBounty
      })
    }
  },[])
